  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square bg-bunq-black overflow-hidden">
        ...
        {/* Show amount only if user opted in */}
        {post.show_amount != null && post.amount != null && post.show_amount && (
      ...
      {post.caption && (
        <div className="px-4 pt-3 pb-2">
          ...
          <div className="flex items-center gap-1 mt-1 text-[10px] text-bunq-mute">
      ...
      {/* Reactions row */}
      <div className="px-4 py-2 flex items-center gap-3 text-bunq-mute">
        {['🔥', '💀', '😍', '🤑'].map(e => (
          <button key={e} className="text-lg hover:scale-110 transition-transform">{e}</button>
        ))}
        <div className="flex-1" />
        <button className="text-bunq-mute hover:text-white">↗</button>
      </div>
